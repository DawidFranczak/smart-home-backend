    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('led_start', models.TimeField(default=aquarium.models.default_time)),
                ('led_stop', models.TimeField(default=aquarium.models.default_time)),
                ('fluo_start', models.TimeField(default=aquarium.models.default_time)),
                ('fluo_stop', models.TimeField(default=aquarium.models.default_time)),
